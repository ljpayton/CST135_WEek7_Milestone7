...
public class Candy extends Snack implements Comparable<Product> {
	...
	public Candy(String name, String brand, String productClass, double price, double sugar, double protein,
			double sodium, double calories) {
		super(name, brand, productClass, price, sugar, protein, sodium, calories);
	}

	// Formatted Constructor
	public Candy(String name, String productType, double price) {
		super(name, productType, price);
	}

	// Formatted Constructor
	public Candy(String name, String productType,int quantity, double price) {
